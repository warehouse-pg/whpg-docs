...
This Ansible playbook shows how tasks described in [Installing the WarehousePG Software](install_whpg.md) might be automated using [Ansible](https://docs.ansible.com).
