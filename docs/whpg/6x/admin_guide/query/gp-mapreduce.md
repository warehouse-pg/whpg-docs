...
Refer to [gpmapreduce](../../ref_guide/utility_guide/reference/gpmapreduce.md) for details about running the WarehousePG MapReduce program.
...
Refer to [gpmapreduce.yaml](../../ref_guide/utility_guide/reference/gpmapreduce-yaml.md) for detailed information about the WarehousePG MapReduce configuration file format and the keys and values supported.
