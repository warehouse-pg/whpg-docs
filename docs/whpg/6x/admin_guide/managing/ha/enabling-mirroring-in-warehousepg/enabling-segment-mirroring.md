...
2.  Use [gpssh-exkeys](../../../../ref_guide/utility_guide/reference/gpssh-exkeys.md) to ensure that the segment hosts can SSH and SCP to each other without a password prompt.
