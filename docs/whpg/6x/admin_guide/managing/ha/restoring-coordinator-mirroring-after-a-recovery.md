...
4.  After the initialization completes, check the status of standby coordinator, mdw. Run [gpstate](../../../ref_guide/utility_guide/reference/gpstate.md) with the `-f` option to check the standby coordinator status:
