...
Refer to the WarehousePG [LDAP Authentication](../../../security-guide/Authenticate.md#ldap_auth) discussion for more information on configuring an HBA file for LDAP.
