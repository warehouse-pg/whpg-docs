...
-   **[Example 1—WarehousePG file server (gpfdist)](example-1-warehousepg-file-server-gpfdist.md)**  

-   **[Example 2—Hadoop file server (pxf)](example-2-hadoop-file-server.md)**  

**Parent topic:** [Unloading Data from WarehousePG](../index.md)
