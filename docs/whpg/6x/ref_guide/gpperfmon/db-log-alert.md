...
See [Alert Log Processing and Log Rotation](index.md#section_ok2_wd1_41b) for information about configuring the system logger for `gpperfmon`.
...
**Parent topic:** [The gpperfmon Database](index.md)
