...
-   usinglist
    ...
    A list of table expressions, allowing columns from other tables to appear in the `WHERE` condition. This is similar to the list of tables that can be specified in the `FROM` Clause of a [SELECT](SELECT.md) statement; for example, an alias for the table name can be specified. Do not repeat the target table in the `usinglist`, unless you wish to set up a self-join.
...
-   cursor_name
    ...
    See [DECLARE](DECLARE.md) for more information about creating cursors.
