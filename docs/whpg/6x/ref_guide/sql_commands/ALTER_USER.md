...
`ALTER USER` is an alias for `ALTER ROLE`. See [ALTER ROLE](ALTER_ROLE.md) for more information.
...
[ALTER ROLE](ALTER_ROLE.md), [CREATE USER](CREATE_USER.md), [DROP USER](DROP_USER.md)
