...
The session default transaction modes can also be set by setting the configuration parameters [default_transaction_isolation](../config_params/guc-list.md), [default_transaction_read_only](../config_params/guc-list.md), and [default_transaction_deferrable](../config_params/guc-list.md).
