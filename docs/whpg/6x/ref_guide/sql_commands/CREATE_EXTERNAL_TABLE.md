...
The limit for the number of initial rejected rows can be changed with the WarehousePG server configuration parameter `gp_initial_bad_row_limit`. See [Server Configuration Parameters](../config_params/index.md) for information about the parameter.
