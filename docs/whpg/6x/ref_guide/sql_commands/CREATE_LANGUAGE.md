...
[ALTER LANGUAGE](ALTER_LANGUAGE.md), [CREATE EXTENSION](CREATE_EXTENSION.md), [CREATE FUNCTION](CREATE_FUNCTION.md), [DROP EXTENSION](DROP_EXTENSION.md), [DROP LANGUAGE](DROP_LANGUAGE.md), [GRANT](GRANT.md) [DO](DO.md)
