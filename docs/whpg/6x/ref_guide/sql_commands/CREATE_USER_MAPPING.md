...
[ALTER USER MAPPING](ALTER_USER_MAPPING.md), [DROP USER MAPPING](DROP_USER_MAPPING.md), [DROP USER MAPPING](DROP_USER_MAPPING.md), [CREATE FOREIGN DATA WRAPPER](CREATE_FOREIGN_DATA_WRAPPER.md), [CREATE SERVER](CREATE_SERVER.md)
