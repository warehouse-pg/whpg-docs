...
[ALTER SERVER](ALTER_SERVER.md), [DROP SERVER](DROP_SERVER.md), [CREATE FOREIGN DATA WRAPPER](CREATE_FOREIGN_DATA_WRAPPER.md), [CREATE USER MAPPING](CREATE_USER_MAPPING.md)
