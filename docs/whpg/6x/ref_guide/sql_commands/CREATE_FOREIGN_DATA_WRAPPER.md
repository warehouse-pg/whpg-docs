...
[ALTER FOREIGN DATA WRAPPER](ALTER_FOREIGN_DATA_WRAPPER.md), [DROP FOREIGN DATA WRAPPER](DROP_FOREIGN_DATA_WRAPPER.md), [CREATE SERVER](CREATE_SERVER.md), [CREATE USER MAPPING](CREATE_USER_MAPPING.md)
