...
The `dblink` module is installed when you install WarehousePG. Before you can use any of the functions defined in the module, you must register the `dblink` extension in each database in which you want to use the functions. Refer to [Installing Extensions](../../../install_guide/additional_modules/index.md) for more information.
...
Refer to [SSL Client Authentication](../../../security-guide/Authenticate.md#ssl_postgresql) for information about configuring WarehousePG to use SSL.
