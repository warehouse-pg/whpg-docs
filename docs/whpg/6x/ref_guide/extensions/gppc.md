...
(The WarehousePG [`client_min_messages`](../config_params/guc-list.md) server configuration parameter governs the current client logging level. The [`log_min_messages`](../config_params/guc-list.md) configuration parameter governs the current log-to-logfile level.)
