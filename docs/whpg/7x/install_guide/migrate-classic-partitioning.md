...
-   [gp_partition_template](../ref_guide/system_catalogs/system_catalogs_definitions/gp_partition_template.md)
-   [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md)
-   [pg_partition_tree()](../admin_guide/ddl/ddl-partition/index.md#topic76)
-   [pg_partition_ancestors()](../admin_guide/ddl/ddl-partition/index.md#topic76)
-   [pg_partition_root()](../admin_guide/ddl/ddl-partition/index.md#topic76)
...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| schemaname               | The name of the schema in which the root partitioned table resides.                                                | Use `pg_partition_root()` to obtain the root object identifier, and then query [pg_namespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_namespace.md).                                                                                                                                                         |
| tablename                | The name of the root partitioned table.                                                                            | Use `pg_partition_root()` to obtain the root object identifier, and then query [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.md).                                                                                                                                                                 |
| partitionschemaname      | The namespace of the leaf partition.                                                                               | [pg_namespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_namespace.md)                                                                                                                                                                                                                                         |
| partitiontablename       | The table name of the leaf partition (the table name you use to access the partition directly).                    | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.md)                                                                                                                                                                                                                                                 |
...
| parentpartitiontablename | The table name of the parent table of this partition.                                                              | Get the parent object identifier via [pg_inherits](../ref_guide/system_catalogs/system_catalogs_definitions/pg_inherits.md) and then query [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.md).                                                                                                     |
| parentpartitionname      | The partition name of the parent table of this partition.                                                          | N/A                                                                                                                                                                                                                                                                                                                              |
| partitiontype            | The type of partition (range or list).                                                                             | Get the parent object identifier via [pg_inherits](../ref_guide/system_catalogs/system_catalogs_definitions/pg_inherits.md) and then query [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md).                                                                             |
...
| parenttablespace         | The tablespace of the parent table of this partition.                                                              | Get the parent object identifier via [pg_inherits](../ref_guide/system_catalogs/system_catalogs_definitions/pg_inherits.md) and then query [pg_tablespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_tablespace.md).                                                                                           |
| partitiontablespace      | The tablespace of this partition.                                                                                  | [pg_tablespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_tablespace.md)                                                                                                                                                                                                                                       |
...
| Column Name               | WarehousePG 6 Description                                                                                                                   | WarehousePG 7 Equivalent                                                                                                                                                            |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| schemaname                | The name of the schema in which the partitioned table resides.                                                                              | Get the root partitioned table object identifier via `pg_partition_root()` and then query [pg_namespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_namespace.md). |
| tablename                 | The table name of the partitioned table.                                                                                                    | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.md)                                                                                                    |
| columnname                | The name of the partition key column.                                                                                                       | [pg_attribute](../ref_guide/system_catalogs/system_catalogs_definitions/pg_attribute.md)                                                                                            |
...
| parchildrelid     | The table identifier of the partition.                                                                                                                                                                                                                                                                                            | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.md)                                  |
| parparentrule     | The row identifier of the rule associated with the parent table of this partition.                                                                                                                                                                                                                                                | N/A (removed object)                                                                                              |
| parname           | The given name of this partition.                                                                                                                                                                                                                                                                                                 | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.md)                                  |
...
| parreloptions     | An array describing the storage characteristics of the particular partition.                                                                                                                                                                                                                                                      | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.md).reloptions                       |
...
The majority of this information resides in [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md) in WarehousePG 7.

| Column Name   | WarehousePG 6 Description                                                                                                                           | WarehousePG 7 Equivalent                                                                                                                                                                                                                        |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| parrelid      | The object identifier of the table.                                                                                                                 | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md).partrelid                                                                                                                              |
| parkind       | The partition type - R for range or L for list.                                                                                                     | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md).partstrat                                                                                                                              |
| parlevel      | The partition level of this row: 0 for the top-level parent table, 1 for the first level under the parent table, 2 for the second level, and so on. | Cross-check [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md) and `pg_partition_root()/pg_partition_tree()`, similar to how you retrieve [pg_partitions](#pg_partitions).partitionlevel. |
| paristemplate | Whether or not this row represents a subpartition template definition (`true`) or an actual partitioning level (`false`).                           | Cross-check [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md).partrelid with [gp_partition_template](../ref_guide/system_catalogs/system_catalogs_definitions/gp_partition_template.md). |
| parnatts      | The number of attributes that define this level.                                                                                                    | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md).partnatts                                                                                                                              |
| paratts       | An array of the attribute numbers (as in `pg_attribute.attnum`) of the attributes that participate in defining this level.                          | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md).partattrs                                                                                                                              |
| parclass      | The operator class identifier(s) of the partition columns.                                                                                          | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.md).partclass                                                                                                                              |
...
The WarehousePG 6 `pg_partition_encoding` table describes the available column compression options for a subpartition template. This information is stored in [gp_partition_template](../ref_guide/system_catalogs/system_catalogs_definitions/gp_partition_template.md) in WarehousePG 7.
