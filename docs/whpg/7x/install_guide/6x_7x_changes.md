...
-   Removes some features and objects that were in Greeplum 6. See [Features and Objects Removed in WarehousePG 7](../ref_guide/removed-features-objects.md).

-   Changes some server configuration parameters. See [Server Configuration Parameter Changes from WarehousePG 6 to WarehousePG 7](../ref_guide/guc-changes-6to7.md).

-   Changes the partitioning system catalogs. See [Changes in Partitioning](../admin_guide/ddl/ddl-partition/about-part-changes.md) and [Migrating Partition Maintenance Scripts to the New WarehousePG 7 Partitioning Catalogs](migrate-classic-partitioning.md).

-   Makes changes to external tables. See [Changes to External Tables](../admin_guide/external/external-tables/about_exttab_7.md).

-   Makes changes to resource groups. See [Changes to Resource Groups](../admin_guide/performance/wlmgmt/about-resgroups-changes.md).

-   Makes changes to system views and system tables. See [System Catalog Changes between WarehousePG 6 and WarehousePG 7](../ref_guide/system-changes-6to7.md).
