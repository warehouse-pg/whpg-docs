...
-   Read carefully through [Important Changes between WHPG 6 and WHPG 7](6x_7x_changes.md) to identify changes you may need to make in your application before upgrading to WarehousePG 7.
...
3.  Initalize a WarehousePG 7 cluster on the destination hardware, by issuing the [`gpinitsystem` command](../ref_guide/utility_guide/reference/gpinitsystem.md).
