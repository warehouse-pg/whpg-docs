...
Alternative syntaxes for referencing ordered-set aggregates are described under [ALTER AGGREGATE](ALTER_AGGREGATE.md).
...
[ALTER AGGREGATE](ALTER_AGGREGATE.md), [CREATE AGGREGATE](CREATE_AGGREGATE.md)
