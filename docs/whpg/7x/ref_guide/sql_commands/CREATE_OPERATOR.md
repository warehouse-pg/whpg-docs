...
Use [DROP OPERATOR](DROP_OPERATOR.md) to delete user-defined operators from a database. Use [ALTER OPERATOR](ALTER_OPERATOR.md) to modify operators in a database.
...
[CREATE FUNCTION](CREATE_FUNCTION.md), [CREATE TYPE](CREATE_TYPE.md), [ALTER OPERATOR](ALTER_OPERATOR.md), [CREATE OPERATOR CLASS](CREATE_OPERATOR_CLASS.md), [DROP OPERATOR](DROP_OPERATOR.md)
