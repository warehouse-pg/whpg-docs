...
Use [RELEASE SAVEPOINT](RELEASE_SAVEPOINT.md) to destroy a savepoint without discarding the effects of commands run after it was established.
...
[BEGIN](BEGIN.md), [COMMIT](COMMIT.md), [RELEASE SAVEPOINT](RELEASE_SAVEPOINT.md), [ROLLBACK](ROLLBACK.md), [SAVEPOINT](SAVEPOINT.md)
