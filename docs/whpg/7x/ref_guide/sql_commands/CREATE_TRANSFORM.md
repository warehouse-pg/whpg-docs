...
Use [DROP TRANSFORM](DROP_TRANSFORM.md) to remove transforms.
...
[CREATE FUNCTION](CREATE_FUNCTION.md), [CREATE LANGUAGE](CREATE_LANGUAGE.md), [CREATE TYPE](CREATE_TYPE.md), [DROP TRANSFORM](DROP_TRANSFORM.md)
