...
It is also possible to tie a session default to a specific role rather than to a database; see [ALTER ROLE](ALTER_ROLE.md). Role-specific settings override database-specific ones if there is a conflict.
