...
> **Note** The `gpreload` utility is deprecated and will be removed in the next major release of WarehousePG. Use [ALTER TABLE REPACK BY COLUMNS](../../sql_commands/ALTER_TABLE.md) to physically reorder a table based on one or more columns. 
