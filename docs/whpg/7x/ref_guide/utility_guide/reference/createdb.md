...
`createdb` is a wrapper around the SQL command [CREATE DATABASE](../../sql_commands/CREATE_DATABASE.md) .
...
The options `-D`, `-l`, `-E`, `-O`, and `-T` correspond to options of the underlying SQL command `CREATE DATABASE`; see [CREATE DATABASE](../../sql_commands/CREATE_DATABASE.md) in the *WarehousePG Reference Guide* for more information about them.
...
[CREATE DATABASE](../../sql_commands/CREATE_DATABASE.md), [dropdb](dropdb.md)
