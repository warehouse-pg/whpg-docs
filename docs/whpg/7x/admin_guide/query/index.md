...
-   **[Using Optimizer Hints](query-optimizer-hints.md)**  
    Override specific planner choices, such as scan method, join method, or join order, for a single query with `pg_hint_plan`.
...
-   **[Just-in-Time Compilation (JIT)](just-in-time.md)**
