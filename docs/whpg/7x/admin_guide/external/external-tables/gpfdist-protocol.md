...
The [gpfdist](../../../ref_guide/utility_guide/reference/gpfdist.md) utility serves external data files from a directory on a file host to all WarehousePG segments in parallel.
...
For more information about configuring `gpfdist`, see [Using the WarehousePG Parallel File Server (gpfdist)](../using-gpfdist.md).
