...
(See also [Understanding the External Table to Foreign Table Mapping](map_ext_to_foreign.md) for detailed information about the external table to foreign table conversion, and its runtime implications.)

**Parent topic:** [Accessing External Data with External Tables](index.md)
...
-   The [pg_exttable](../../../ref_guide/system_catalogs/catalog_ref-views.md#pg_exttable) system catalog (now a view) provides the same information.
...
-   WarehousePG 7 uses foreign table data structures and catalogs to internally represent external tables. Use the [pg_foreign_table](../../../ref_guide/system_catalogs/system_catalogs_definitions/pg_foreign_table.md) system catalog table and the `ftoptions` column to view the table definition.
...
-   The [pg_exttable](../../../ref_guide/system_catalogs/catalog_ref-views.md#pg_exttable) system catalog is now a view.
...
-   Because an external table is internally represented as a foreign table:
    ...
    -   External tables are included in the foreign table catalogs, for example [pg_foreign_table](../../../ref_guide/system_catalogs/system_catalogs_definitions/pg_foreign_table.md).
