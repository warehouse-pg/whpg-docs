...
-   External tables are included in the foreign table catalogs. Use the [pg_foreign_table](../../../ref_guide/system_catalogs/system_catalogs_definitions/pg_foreign_table.md) system catalog table and the `ftoptions` column to view external table definitions.
