...
The physical RAM and OS configuration are usually managed by the platform team and system administrators. See the [WarehousePG Installation Guide](../../install_guide/config_os.md#topic3) for the recommended kernel parameters and for how to set the `/etc/sysctl.conf` file parameters.
