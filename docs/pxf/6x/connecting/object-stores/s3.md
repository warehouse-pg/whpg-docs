...
description: Configure PXF to read and write data in Amazon S3 or MinIO, and query it from WarehousePG.
---
...
1. Edit the site XML file to authenticate to S3, using whichever of the following methods fits your environment.
    ...
    See [Configuration templates](../../reference/configuration-templates.md#s3-sitexml) for the full list of `s3-site.xml` properties, or [minio-site.xml](../../reference/configuration-templates.md#minio-sitexml) for MinIO and other S3-compatible stores.
