...
navTitle: Azure
description: Configure PXF to read and write data in Azure Blob Storage or Azure Data Lake Storage, and query it from WarehousePG.
---
...
See [Configuration templates](../../reference/configuration-templates.md#wasbs-sitexml) for the full list of `wasbs-site.xml` properties.
...
See [Configuration templates](../../reference/configuration-templates.md#abfss-sitexml) for the full list of `abfss-site.xml` properties.
