...
For information about the WarehousePG Database utilities, see the *WarehousePG Database Utility Guide*.
...
1.  Stop the WarehousePG Database coordinator instance on the standby coordinator. For example:
...
5.  After the original coordinator host runs the primary WarehousePG Database coordinator, you can initialize a standby coordinator on the original standby coordinator host. For example:
