...
The [gpinitsystem](../utility_guide/ref/gpinitsystem.html) utility will create a WarehousePG Database system using the values defined in the configuration file.
