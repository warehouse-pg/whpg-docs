...
The `pgaudit` module is installed when you install WarehousePG Database. To use it, enable the extension as a preloaded library and restart WarehousePG Database.
...
Use the output of the above command to enable the `pgaudit` module, along any other shared libraries, and restart WarehousePG Database:
