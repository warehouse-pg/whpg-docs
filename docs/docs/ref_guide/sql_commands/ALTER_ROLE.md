...
`ALTER ROLE` changes the attributes of a WarehousePG Database role. There are several variants of this command.
...
The `ALTER ROLE` statement is a WarehousePG Database extension.
