...
This section provides a high-level overview of the system requirements and feature set of WarehousePG Database. It contains the following topics:
...
This section addresses the important conformance issues of WarehousePG Database as they relate to the SQL standards. For a feature-by-feature list of WarehousePG's support of the latest SQL standard, see [SQL 2008 Optional Feature Compliance](SQL2008_support.html).

### <a id="topic3"></a>Core SQL Conformance 

In the process of building a parallel, shared-nothing database system and query optimizer, certain common SQL constructs are not currently implemented in WarehousePG Database. The following SQL constructs are not supported:
...
7.  Referential integrity constraints \(foreign keys\) are not enforced in WarehousePG Database. Users can declare foreign keys and this information is kept in the system catalog, however.
8.  Sequence manipulation functions `CURRVAL` and `LASTVAL`.

### <a id="topic4"></a>SQL 1992 Conformance 

The following features of SQL 1992 are not supported in WarehousePG Database:

1.  `NATIONAL CHARACTER` \(`NCHAR`\) and `NATIONAL CHARACTER VARYING` \(`NVARCHAR`\). Users can declare the `NCHAR` and `NVARCHAR` types, however they are just synonyms for `CHAR` and `VARCHAR` in WarehousePG Database.
2.  `CREATE ASSERTION` statement.
3.  `INTERVAL` literals are supported in WarehousePG Database, but do not conform to the standard.
...
6.  `UNIQUE` predicate.
7.  `MATCH PARTIAL` for referential integrity checks \(most likely will not be implemented in WarehousePG Database\).

### <a id="topic5"></a>SQL 1999 Conformance 

The following features of SQL 1999 are not supported in WarehousePG Database:

1.  Large Object data types: `BLOB`, `CLOB`, `NCLOB`. However, the `BYTEA` and `TEXT` columns can store very large amounts of data in WarehousePG Database \(hundreds of megabytes\).
2.  `MODULE` \(SQL client modules\).
3.  `CREATE PROCEDURE` \(`SQL/PSM`\). This can be worked around in WarehousePG Database by creating a `FUNCTION` that returns `void`, and invoking the function as follows:
...
4.  The PostgreSQL/WarehousePG function definition language \(`PL/PGSQL`\) is a subset of Oracle's `PL/SQL`, rather than being compatible with the `SQL/PSM` function definition language. WarehousePG Database also supports function definitions written in Python, Perl, Java, and R.
...
The following features of SQL 2003 are not supported in WarehousePG Database:
...
4.  `ROW` data type.
5.  WarehousePG Database syntax for using sequences is non-standard. For example, `nextval('seq')` is used in WarehousePG instead of the standard `NEXT VALUE FOR seq`.
...
9.  WarehousePG array data types are almost SQL standard compliant with some exceptions. Generally customers should not encounter any problems using them.

### <a id="topic7"></a>SQL 2008 Conformance 

The following features of SQL 2008 are not supported in WarehousePG Database:

1.  `BINARY` and `VARBINARY` data types. `BYTEA` can be used in place of `VARBINARY` in WarehousePG Database.
...
WarehousePG Database is based on PostgreSQL 9.4. To support the distributed nature and typical workload of a WarehousePG Database system, some SQL commands have been added or modified, and there are a few PostgreSQL features that are not supported. WarehousePG has also added features not found in PostgreSQL, such as physical data distribution, parallel query optimization, external tables, resource queues, and enhanced table partitioning. For full SQL syntax and references, see the [SQL Commands](sql_commands/sql_ref.html).
...
<table cellpadding="4" cellspacing="0" summary="" id="topic8__ik213423" class="table" frame="border" border="1" rules="all"><caption><span class="tablecap"><span class="table--title-label">Table 1. </span>SQL Support in WarehousePG Database</span></caption><colgroup><col style="width:143pt" /><col style="width:73pt" /><col style="width:233pt" /></colgroup><thead class="thead" style="text-align:left;">
<tr class="row">
<th class="entry nocellnorowborder" style="vertical-align:top;" id="d119146e602">SQL Command
<th class="entry nocellnorowborder" style="vertical-align:top;" id="d119146e605">Supported in WarehousePG
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">Changes the definition of a WarehousePG Database extension - based
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">WarehousePG Database resource management feature - not in
    PostgreSQL.</td>
</tr>
<tr class="row">
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e602 "><code class="ph codeph">ALTER ROLE</code></td>
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">WarehousePG Database Clauses:</strong><p class="p"><code class="ph codeph">RESOURCE QUEUE
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">WarehousePG Database Clauses:</strong><p class="p"><code class="ph codeph">SET DEFAULT
        ENCODING</code></p>
</td>
</tr>
<tr class="row">
...
<p class="p"><strong class="ph b">WarehousePG Database
                    Clauses:</strong></p>
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">Loads a new extension into WarehousePG Database - based on
    PostgreSQL 9.6.</td>
</tr>
<tr class="row">
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">WarehousePG Database parallel ETL feature - not in PostgreSQL
    9.4.</td>
</tr>
<tr class="row">
...
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">Limitations:</strong><p class="p">Functions defined as
      ...
      WarehousePG Database provided that they are run on the coordinator only.
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">WarehousePG Database Clauses:</strong><p class="p"><code class="ph codeph">USING
        bitmap</code> (bitmap
        indexes)</p>
<p class="p"><strong class="ph b">Limitations:</strong></p>
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">Limitations:</strong><p class="p">The function used to implement the operator must be an <code class="ph codeph">IMMUTABLE</code> function.</p>
</td>
</tr>
<tr class="row">
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">WarehousePG Database resource management feature - not in PostgreSQL 9.4.</td>
</tr>
<tr class="row">
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e602 "><code class="ph codeph">CREATE ROLE</code></td>
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">WarehousePG Database Clauses:</strong><p class="p"><code class="ph codeph">RESOURCE QUEUE</code><em class="ph i">queue_name</em><code class="ph codeph"> | none</code></p>
</td>
</tr>
<tr class="row">
...
<p class="p"><code class="ph codeph">UNIQUE</code> or
                  ...
                  include all the distribution key columns of the partitioning
                    key.</p>
<p class="p"><strong class="ph b">WarehousePG Database Clauses:</strong></p>
...
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">WarehousePG Database Clauses:</strong><p class="p">Specify host file system
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">WarehousePG Database Clauses:</strong><p class="p"><code class="ph codeph">COMPRESSTYPE |
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">Removes an extension from WarehousePG Database – based on
                PostgreSQL 9.6.</td>
</tr>
<tr class="row">
...
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d119146e605 ">YES</td>
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">WarehousePG Database parallel retrieve cursor - not in PostgreSQL 9.4.</td>
</tr>
<tr class="row">
...
<p class="p">Text search (<code class="ph codeph">Tsearch2</code>) is
                  not supported</p>
<p class="p"><strong class="ph b">WarehousePG Database Clauses (OLAP):</strong></p>
...
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 ">In PostgreSQL, this only applies to foreign key constraints,
                which are currently not enforced in WarehousePG Database.</td>
</tr>
<tr class="row">
...
<td class="entry cell-norowborder" style="vertical-align:top;" headers="d119146e608 "><strong class="ph b">Limitations:</strong><p class="p"><code class="ph codeph">VACUUM FULL</code> is not
                  recommended in WarehousePG Database.</p>
</td>
</tr>
<tr class="row">
