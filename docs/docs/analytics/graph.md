...
To use the MADlib graph modules, install the version of MADlib corresponding to your WarehousePG Database version. To download the software, access the VMware Tanzu Network. For WarehousePG 6.x, see [Installing MADlib](./madlib.html#topic3).
