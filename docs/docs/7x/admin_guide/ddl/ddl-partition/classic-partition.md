...
If you are already familiar with the *classic* partitioning syntax, refer to [About Changes to Table Partitioning in WarehousePG 7](about-part-changes.md) for information about syntax and behavior changes introduced in version 7.
...
For information about exchanging and altering a leaf partition, see the [ALTER TABLE](../../../ref_guide/sql_commands/ALTER_TABLE.md) command reference.

For information about limitations of partitioned tables that contain a external table partition, see [Limitations of Partitioned Tables](index.md#limitations).
