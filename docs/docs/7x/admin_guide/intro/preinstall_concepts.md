...
-   **[The WarehousePG Coordinator](preinstall_concepts.md)**  

-   **[The Segments](preinstall_concepts.md)**  

-   **[The Interconnect](preinstall_concepts.md)**  

-   **[ETL Hosts for Data Loading](preinstall_concepts.md)**  

**Parent topic:** [Installing and Upgrading WarehousePG](../../install_guide/index.md)
...
**Parent topic:** [Introduction to WarehousePG](preinstall_concepts.md)
