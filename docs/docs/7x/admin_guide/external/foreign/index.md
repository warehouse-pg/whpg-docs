...
The WarehousePG distribution includes the [postgres_fdw](../../../ref_guide/modules/postgres_fdw.md) foreign data wrapper. You can also download and install the EDB-provided module [whpg_fdw](../../../ref_guide/modules/edb_modules/whpg_fdw.md).
...
For additional information, refer to the [CREATE FOREIGN DATA WRAPPER](../../../ref_guide/sql_commands/CREATE_FOREIGN_DATA_WRAPPER.md), [CREATE SERVER](../../../ref_guide/sql_commands/CREATE_SERVER.md), [CREATE USER MAPPING](../../../ref_guide/sql_commands/CREATE_USER_MAPPING.md), and [CREATE FOREIGN TABLE](../../../ref_guide/sql_commands/CREATE_FOREIGN_TABLE.md) SQL reference pages.
