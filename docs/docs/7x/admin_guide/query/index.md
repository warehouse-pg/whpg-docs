...
redirects:
  - query
  - /supported-open-source/warehousepg/warehousepg/admin_guide/query/topics
...
-   **[About WarehousePG Query Processing](parallel-proc)**  
...
-   **[WITH Queries (Common Table Expressions)](CTE-query)**  
...
-   **[Managing Spill Files Generated by Queries](spill-files)**  
...
-   **[Just-in-Time Compilation (JIT)](just-in-time)**
