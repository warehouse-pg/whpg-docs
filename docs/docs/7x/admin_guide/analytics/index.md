...
[Text Analytics and Search](../query/textsearch/index.md) enables processing of mass quantities of raw text data (such as social media feeds or e-mail databases) into mission-critical information that guides project and business decisions. 
