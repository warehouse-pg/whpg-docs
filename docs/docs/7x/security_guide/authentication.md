...
> **Note** For information about encrypting data between the `gpfdist` server and WarehousePG segment hosts, see [Encrypting gpfdist Connections](encryption.html).
