...
| [Python 3.11 Data Science Module Package](data_sci_pkgs/install_python_dsmod.md) | 1.2 | |
| [PL/R](../admin_guide/analytics/procedural_languages/pl_r.md) | 3.1.1 | (CentOS) R 3.3.3<br />(Ubuntu) You install R 3.5.1+. |
| [R Data Science Library Package](data_sci_pkgs/install_r_dslib.md) | 2.0.2 | |
