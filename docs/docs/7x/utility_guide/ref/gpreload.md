...
> **Note** The `gpreload` utility is deprecated and will be removed in the next major release of WarehousePG. Use [ALTER TABLE REPACK BY COLUMNS](../../ref_guide/sql_commands/ALTER_TABLE.html) to physically reorder a table based on one or more columns. 
