...
\(The WarehousePG [`client_min_messages`](../config_params/guc-list.html) server configuration parameter governs the current client logging level. The [`log_min_messages`](../config_params/guc-list.html) configuration parameter governs the current log-to-logfile level.\)
...
|-----------------|------------------|-----------|
|SPI\_connect\(\)|GppcSPIConnect\(\)|Connect to the WarehousePG server programming interface.|
|SPI\_finish\(\)|GppcSPIFinish\(\)|Disconnect from the WarehousePG server programming interface.|
