...
The `pg_resgroupcapability` system catalog table contains information about the capabilities and limits of defined WarehousePG resource groups. You can join this table to the [pg_resgroup](pg_resgroup.md) table by resource group object ID.
