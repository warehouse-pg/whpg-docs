...
The `pg_available_extension_versions` view lists the specific extension versions that are available for installation. The [pg_extension](pg_extension.md) system catalog table shows the extensions currently installed.
