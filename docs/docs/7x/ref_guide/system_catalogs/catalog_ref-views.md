...
-   session_level_memory_consumption (See [Monitoring a WarehousePG cluster](../../admin_guide/managing/monitor.html#topic_slt_ddv_1q).)
...
|num\_queued|integer| |The total number of queued transactions for the resource group since the WarehousePG cluster was last started, excluding the num\_queueing.|
|num\_executed|integer| |The total number of transactions run in the resource group since the WarehousePG cluster was last started, excluding the num\_running.|
|total\_queue\_duration|interval| |The total time any transaction was queued since the WarehousePG cluster was last started.|
