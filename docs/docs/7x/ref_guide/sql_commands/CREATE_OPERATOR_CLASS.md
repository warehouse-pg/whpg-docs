...
[ALTER OPERATOR CLASS](ALTER_OPERATOR_CLASS.md), [DROP OPERATOR CLASS](DROP_OPERATOR_CLASS.md), [CREATE OPERATOR FAMILY](CREATE_OPERATOR_FAMILY.md), [ALTER OPERATOR FAMILY](ALTER_OPERATOR_FAMILY.md), [CREATE FUNCTION](CREATE_FUNCTION.md)
