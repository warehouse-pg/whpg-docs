...
Use [DROP CONVERSION](DROP_CONVERSION.md) to remove a user-defined conversion.
...
[ALTER CONVERSION](ALTER_CONVERSION.md), [CREATE FUNCTION](CREATE_FUNCTION.md), [DROP CONVERSION](DROP_CONVERSION.md)
