...
Refer to [About Configuring Row-Level Security Policies](../../admin_guide/manage_access/row_security.md) for more information and practical examples.
...
[ALTER POLICY](ALTER_POLICY.md), [DROP POLICY](DROP_POLICY.md), [ALTER TABLE](ALTER_TABLE.md)
