...
For information about creating and enabling a custom data access protocol, refer to the [Example Custom Data Access Protocol](../../admin_guide/load/example-custom-data-access-protocol/index.md) documentation.
