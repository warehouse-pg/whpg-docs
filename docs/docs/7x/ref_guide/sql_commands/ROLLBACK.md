...
Use [COMMIT](COMMIT.md) to successfully end the current transaction.
...
[BEGIN](BEGIN.md), [COMMIT](COMMIT.md), [ROLLBACK TO SAVEPOINT](ROLLBACK_TO_SAVEPOINT.md), [SAVEPOINT](SAVEPOINT.md)
