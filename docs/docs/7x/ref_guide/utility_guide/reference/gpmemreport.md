...
Interprets the output created by the [gpmemwatcher](gpmemwatcher.md) utility and generates output files in a readable format.
...
The `gpmemreport` utility helps interpret the output file created by the [gpmemwatcher](gpmemwatcher.md) utility.
