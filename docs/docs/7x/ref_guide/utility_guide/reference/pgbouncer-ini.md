...
auth_file
The name of the file containing the user names and passwords to load. The file format is the same as the WarehousePG pg_auth file. Refer to the [PgBouncer Authentication File Format](../../../admin_guide/managing/access_db/pgbouncer.md#pgb_auth) for more information.
...
auth_hba_file
HBA configuration file to use when `auth_type` is `hba`. Refer to the [Configuring HBA-based Authentication for PgBouncer](../../../admin_guide/managing/access_db/pgbouncer.md#pgb_hba) and [Configuring LDAP-based Authentication for PgBouncer](../../../admin_guide/managing/access_db/pgbouncer.md#pgb_ldap) for more information.
...
auth_key_file
If you are connecting to LDAP with an encrypted password, `auth_key_file` identifies the file system location of the encryption key. Refer to [About Specifying an Encrypted LDAP Password](../../../admin_guide/managing/access_db/pgbouncer.md#pgb_ldap_encrypt_passwd) for more information.
...
[pgbouncer](pgbouncer.md), [pgbouncer-admin](pgbouncer-admin.md), [PgBouncer Configuration Page](https://pgbouncer.github.io/config.html)
