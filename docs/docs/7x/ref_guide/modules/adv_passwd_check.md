...
|--------------|----|-------------|-----------|
|minimum\_length|int|8|The minimum allowable length of a WarehousePG password.|
|maximum\_length|int|15|The maximum allowable length of a WarehousePG password.|
|special\_chars|string|!@\#$%^&\*\(\)\_+\{\}\|<\>?=|The set of characters that WarehousePG considers to be special characters in a password.|
