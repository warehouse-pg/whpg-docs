...
Refer to [Understanding the External Table to Foreign Table Mapping](../../admin_guide/external/external-tables/map_ext_to_foreign.md) for more information about the conversion and runtime implications.
