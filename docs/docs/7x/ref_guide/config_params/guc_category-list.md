...
These parameters control the usage of GPORCA by WarehousePG. For information about GPORCA, see [About GPORCA](../../admin_guide/query/topics/query-piv-optimizer.html) in the *WarehousePG Administrator Guide*.
