...
> **Note** After completing table redistribution, run the `VACUUM ANALYZE` and `REINDEX`commands on the catalog tables to update table statistics, and rebuild indexes. See [Routine Vacuum and Analyze](../maintain.md) in the *Administration Guide* and [`VACUUM`](../../../ref_guide/sql_commands/VACUUM.md#er20941) in the *Reference Guide*.
...
-   a current progress summary, the estimated rate of table redistribution, and the estimated time to completion. Use *[gpexpand.expansion_progress](../../../ref_guide/system_catalogs/system_catalogs_definitions/gpexpand_expansion_progress.md)*, as described in [Viewing Expansion Status](#topic32).
