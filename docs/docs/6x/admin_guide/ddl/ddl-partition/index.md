...
You can look up information about your partition design using the *[pg_partitions](../../../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitions.md)* system view. For example, to see the partition design of the *sales* table:
...
-   *[pg_partition](../../../ref_guide/system_catalogs/system_catalogs_definitions/pg_partition.md)*- Tracks partitioned tables and their inheritance level relationships.
-   *[pg_partition_templates](../../../ref_guide/system_catalogs/system_catalogs_definitions/pg_partition_templates.md)*- Shows the subpartitions created using a subpartition template.
-   *[pg_partition_columns](../../../ref_guide/system_catalogs/system_catalogs_definitions/pg_partition_columns.md)* - Shows the partition key columns used in a partition design.
