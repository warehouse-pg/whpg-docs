...
For information about the supported WarehousePG extension packages and software versions, see [Extensions](../../install_guide/platform-requirements.md#extensions) in the Platform Requirements topic.
