...
A PL/pgSQL function’s volatility classification has implications on how WarehousePG caches plans that reference the function. Refer to [Function Volatility and Plan Caching](../../query/functions-operators.md#topic281) in the *WarehousePG Administrator Guide* for information on plan caching considerations for WarehousePG function volatility categories.
...
For a summary of built-in WarehousePG functions, see [Summary of Built-in Functions](../../../ref_guide/function-summary.md) in the *WarehousePG Reference Guide*. For information about using WarehousePG functions see "Querying Data" in the *WarehousePG Administrator Guide*
