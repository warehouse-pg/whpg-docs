...
1.  Author the send, receive, and (optionally) validator functions in C, with a predefined API. These functions are compiled and registered with the WarehousePG. For an example custom protocol, see [Example Custom Data Access Protocol](../example-custom-data-access-protocol/index.md).
