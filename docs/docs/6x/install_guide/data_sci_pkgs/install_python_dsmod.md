...
For information about the WarehousePG PL/Python Language, see [WarehousePG PL/Python Language Extension](../../admin_guide/analytics/procedural_languages/pl_python.md).
