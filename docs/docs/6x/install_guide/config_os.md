...
1.  Make sure your host systems meet the requirements described in [Platform Requirements](platform-requirements.md).
...
> **Note** Automating the configuration steps described in this topic and [Installing the WarehousePG Software](install_whpg.md) with a system provisioning tool, such as Ansible, Chef, or Puppet, can save time and ensure a reliable and repeatable WarehousePG installation.
...
For additional requirements and recommendations for cloud deployments, see [WarehousePG Cloud Technical Recommendations](platform-requirements.md#public-cloud).
