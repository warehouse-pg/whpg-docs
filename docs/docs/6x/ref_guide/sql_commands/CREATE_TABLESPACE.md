...
A user with appropriate privileges can pass a tablespace name to [CREATE DATABASE](CREATE_DATABASE.md), [CREATE TABLE](CREATE_TABLE.md), or [CREATE INDEX](CREATE_INDEX.md) to have the data files for these objects stored within the specified tablespace.
