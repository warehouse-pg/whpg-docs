...
The extensions currently available for loading can be identified from the *[pg_available_extensions](../system_catalogs/system_catalogs_definitions/pg_available_extensions.md)* or *[pg_available_extension_versions](../system_catalogs/system_catalogs_definitions/pg_available_extension_versions.md)* system views.
...
[ALTER EXTENSION](ALTER_EXTENSION.md), [DROP EXTENSION](DROP_EXTENSION.md)
