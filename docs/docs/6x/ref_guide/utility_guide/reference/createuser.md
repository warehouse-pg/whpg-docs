...
-   \--replication
    ...
    The new user will have the `REPLICATION` privilege, which is described more fully in the documentation for [CREATE ROLE](../../sql_commands/CREATE_ROLE.md).

-   \--no-replication

    The new user will not have the `REPLICATION` privilege, which is described more fully in the documentation for [CREATE ROLE](../../sql_commands/CREATE_ROLE.md).
...
[CREATE ROLE](../../sql_commands/CREATE_ROLE.md), [dropuser](dropuser.md)
