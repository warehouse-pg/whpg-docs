...
-   [Authentication](Authenticate.md) covers the mechanisms that are supported and that can be used by the WarehousePG server to establish the identity of a client application.
