...
See [Setting the WarehousePG Recommended OS Parameters](../install_guide/config_os.md#sysctl_file) and [Memory and Resource Management with Resource Queues](workloads.md).
