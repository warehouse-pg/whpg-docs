...
-   Do not configure the operating system to use huge pages. See the [Recommended OS Parameters Settings](../install_guide/config_os.md#huge_pages) in the *WarehousePG Installation Guide*.
