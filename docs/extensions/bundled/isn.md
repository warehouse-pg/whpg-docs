---
title: isn
description: Provides data types for international product numbering standards (EAN13, UPC, ISBN, ISMN, ISSN).
redirects:
  - /docs/6x/ref_guide/modules/bundled/isn
  - /docs/7x/ref_guide/modules/bundled/isn
  - /docs/7x/ref_guide/modules/isn
---
