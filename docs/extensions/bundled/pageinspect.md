---
title: pageinspect
description: Provides functions for low-level inspection of the contents of database pages, available to superusers only.
redirects:
  - /docs/6x/ref_guide/modules/bundled/pageinspect
  - /docs/7x/ref_guide/modules/bundled/pageinspect
  - /docs/7x/ref_guide/modules/pageinspect
---
...
Refer to [Installing Extensions](/docs/7x/install_guide/additional_modules/index.md) for more information.
