...
redirects:
  - /docs/7x/ref_guide/modules/bundled/tsm_system_rows
  - /docs/7x/ref_guide/modules/tsm_system_rows
---
...
The `tsm_system_rows` module is installed when you install WarehousePG. Before you can use any of the functions defined in the module, you must register the `tsm_system_rows` extension in each database where you want to use the functions. Refer to [Installing Extensions](/docs/7x/install_guide/additional_modules/index.md) for more information.
