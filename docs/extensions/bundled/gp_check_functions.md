...
description: Provides views to check for orphaned and missing relation files, and a function to move orphaned files.
redirects:
  - /docs/6x/ref_guide/modules/bundled/gp_check_functions
---
