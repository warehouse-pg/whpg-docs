...
redirects:
  - /docs/6x/ref_guide/modules/bundled/gp_subtransaction_overflow
...
For more information on how to use this module, see [Monitoring a WarehousePG cluster](/docs/6x/admin_guide/managing/monitor.md#checking-for-and-terminating-overflowed-backends).
