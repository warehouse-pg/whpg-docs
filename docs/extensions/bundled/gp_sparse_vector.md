...
description: Implements a data type that uses compressed storage of zeros to make vector computations on floating point numbers faster.
redirects:
  - /docs/6x/ref_guide/modules/bundled/gp_sparse_vector
  - /docs/7x/ref_guide/modules/bundled/gp_sparse_vector
  - /docs/7x/ref_guide/modules/gp_sparse_vector
---
