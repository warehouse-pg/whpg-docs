...
description: Tracks execution statistics of all SQL statements. Requires shared_preload_libraries.
redirects:
  - /docs/7x/ref_guide/modules/bundled/pg_stat_statements
  - /docs/7x/ref_guide/modules/pg_stat_statements
---
