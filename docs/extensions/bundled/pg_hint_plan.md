---
title: pg_hint_plan
description: Controls the execution plan the planner chooses for a query, using hints placed in SQL comments.
redirects:
  - /docs/7x/ref_guide/modules/bundled/pg_hint_plan
---
...
See [Storing hints in a table](/docs/7x/admin_guide/query/query-optimizer-hints.md#storing-hints-in-a-table) for how to attach a hint to a query you can't add a comment to.
