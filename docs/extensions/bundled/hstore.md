---
title: hstore
description: Provides a data type for storing sets of key/value pairs within a single value.
redirects:
  - /docs/6x/ref_guide/modules/bundled/hstore
  - /docs/7x/ref_guide/modules/bundled/hstore
  - /docs/7x/ref_guide/modules/hstore
---
...
The `hstore` module is installed when you install WarehousePG. Before you can use any of the data types or functions defined in the module, you must register the `hstore` extension in each database in which you want to use the objects. Refer to [Installing Extensions](/docs/7x/install_guide/additional_modules/index.md) for more information.
