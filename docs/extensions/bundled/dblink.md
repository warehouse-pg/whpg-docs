...
redirects:
  - /docs/6x/ref_guide/modules/bundled/dblink
  - /docs/7x/ref_guide/modules/bundled/dblink
  - /docs/7x/ref_guide/modules/dblink
---
...
The `dblink` module is installed when you install WarehousePG. Before you can use any of the functions defined in the module, you must register the `dblink` extension in each database in which you want to use the functions. Refer to [Installing Extensions](/docs/7x/install_guide/additional_modules/index.md) for more information.
...
Refer to [SSL Client Authentication](/docs/7x/security_guide/authentication.md#ssl_postgresql) for information about configuring WarehousePG to use SSL.
