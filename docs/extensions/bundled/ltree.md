---
title: ltree
description: Provides data types for representing labels of data stored in a hierarchical tree-like structure.
redirects:
  - /docs/6x/ref_guide/modules/bundled/ltree
  - /docs/7x/ref_guide/modules/bundled/ltree
  - /docs/7x/ref_guide/modules/ltree
---
