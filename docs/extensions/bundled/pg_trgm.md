---
title: pg_trgm
description: Provides functions and operators for determining the similarity of alphanumeric text based on trigram matching.
redirects:
  - /docs/6x/ref_guide/modules/bundled/pg_trgm
  - /docs/7x/ref_guide/modules/bundled/pg_trgm
  - /docs/7x/ref_guide/modules/pg_trgm
---
