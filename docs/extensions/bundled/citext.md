...
redirects:
  - /docs/6x/ref_guide/modules/bundled/citext
  - /docs/7x/ref_guide/modules/bundled/citext
  - /docs/7x/ref_guide/modules/citext
---
...
The `citext` module is installed when you install WarehousePG. Before you can use any of the data types, operators, or functions defined in the module, you must register the `citext` extension in each database in which you want to use the objects. Refer to [Installing Extensions](/docs/7x/install_guide/additional_modules/index.md) for more information.
